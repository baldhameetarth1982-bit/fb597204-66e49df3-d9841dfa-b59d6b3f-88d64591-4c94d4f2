...
describe("normalizePlan canonical matrix (Turn 18B.2B)", () => {
  ...
  const cases: Array<{ raw: unknown; status: unknown; end?: string | null; expected: "basic" | "pro" | "premium"; label: string }> = [
    ...
    { raw: "pro", status: "trial", expected: "basic", label: "Stage 1D: trial without expiry denied" },
    { raw: "pro", status: "trialing", expected: "basic", label: "Stage 1D: trialing without expiry denied" },
