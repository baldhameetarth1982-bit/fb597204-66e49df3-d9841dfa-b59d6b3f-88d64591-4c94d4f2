...
- Remaining before Stage 3D closure: execute the checked-in nine-case synthetic posting/reversal/backfill/privacy suite on a fresh disposable database and complete authenticated mobile/desktop accessibility and visual QA. Therefore Stage 3D remains `implemented_unverified`, not complete. Stage 3E remains `not_started`.
