    ...
    try {
      ...
      await openRazorpayForOrder({
        ...
        onSuccess: async (resp) => {
          await confirmSaasSubscriptionPayment({
            data: {
          ...
          <Card className="rounded-2xl border">
            ...
            <CardContent className="space-y-5">
              {isLoading ? (
                ...
                <div
                  role="alert"
                  className="rounded-xl border border-destructive/30 p-4 text-center"
                >
                  <p className="font-medium">This plan couldn't be loaded.</p>
                  <p className="mt-1 text-sm text-muted-foreground">
                    Check the plan link or try again.
                  </p>
                  <Button
                    variant="outline"
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground mt-1">
                        We are completing our payment gateway verification. Checkout will go live
                        shortly. For anything urgent, email{" "}
                        <a href="mailto:sociohub710@gmail.com" className="underline">
