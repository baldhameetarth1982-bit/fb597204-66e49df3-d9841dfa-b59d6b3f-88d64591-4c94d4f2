  ...
  return (
    <div className="container-page space-y-6 py-6 md:py-10">
      <header className="flex flex-col gap-4 border-b border-border pb-5 md:flex-row md:items-end md:justify-between"><div>
          <h1 className="text-2xl font-semibold tracking-tight md:text-[28px] md:leading-[34px]">Audit Center</h1>
          <p className="mt-1 max-w-2xl text-sm text-muted-foreground">Every platform action is recorded. Latest 500 events.</p>
        </div>
      </header>
