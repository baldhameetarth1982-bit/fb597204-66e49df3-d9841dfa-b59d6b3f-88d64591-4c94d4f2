...
COMMENT ON TRIGGER audit_log_immutable ON public.audit_log IS 'Prevents mutation or deletion of canonical audit history, including privileged database access.';